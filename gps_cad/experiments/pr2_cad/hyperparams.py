...
EE_POINTS = np.array([[0.06, 0.0, 0.0], [0.15, 0.05, 0.0], [0.15, -0.05, 0.0]])
...
################################################################################
conditions, condition_info = [1], [np.array([1.38781535, -0.2317441, 2.65237236, -1.94273868, 4.78109335,-0.90467269, -1.56926878])]
if MODE == 'iLQR subset':
...
for info in condition_info:
    ...
    print(info)
    reset_condition = {
        TRIAL_ARM:     {'data': np.array(info), 'mode': 1},
...
#
    ...
    'trial_timeout': 30,
    'exp_dir': EXP_DIR,
    'policy_path': '/home/michael/gps_cad/data_upload/mlp/params.npz',
    'recurrent': False,
}
